...
1. [Responsive Web Design - HTML & CSS](https://www.freecodecamp.org/learn/2022/responsive-web-design/)
2. [JavaScript Algorithms and Data Structures](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)
3. [Front End Development Libraries - HTML, CSS & Javascript](https://www.freecodecamp.org/learn/front-end-development-libraries/)
4. [Java Programming for Beginners](https://www.youtube.com/watch?v=A74TOX803D0)
5. [Spring Boot Tutorial for Beginners (Java Framework)](https://www.youtube.com/watch?v=vtPkZShrvXQ)
6. [Full Stack Development with Java Spring Boot, React, and MongoDB](https://www.youtube.com/watch?v=5PdEmeopJVQ)
7. [Data Visualization](https://www.freecodecamp.org/learn/data-visualization/)
8. [Relational Database](https://www.freecodecamp.org/learn/relational-database/)
9. [Back End Development and APIs](https://www.freecodecamp.org/learn/back-end-development-and-apis/)

### Cybersecurity:
- [Ethical Hacking Playlist - FCC](https://www.youtube.com/playlist?list=PLWKjhJtqVAbnklGh3FNRLECx_2D_vK3mu)
